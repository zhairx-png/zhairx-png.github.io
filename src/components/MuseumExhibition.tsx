              ...
              >
                ...
                >
                  ...
                  <div 
                    ...
                    style={{ 
                      backgroundImage: `url("${import.meta.env.BASE_URL}images/双鱼细节拓片.jpg")`,
                  ...
                  <div 
                    ...
                    style={{
                      backgroundImage: `url("${import.meta.env.BASE_URL}images/双鱼细节拓片浮雕效果.jpg")`,
                      referrerPolicy: 'no-referrer',
                ...
                return (
                  ...
                  >
                    <div 
                      ...
                      style={{ 
                        backgroundImage: `url("${import.meta.env.BASE_URL}${item.image.slice(1)}")`
                      }}
                    />
            ...
            >
              ...
              <div className="w-full md:w-[45%] h-[40%] md:h-full relative overflow-hidden bg-black/50 border-r border-white/5">
                ...
                <motion.div 
                  ...
                  style={{ 
                    backgroundImage: `url("${import.meta.env.BASE_URL}${currentDetail.image.slice(1)}")`
                  }}
                />
